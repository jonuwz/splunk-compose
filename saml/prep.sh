...
cat resources/certs/splunksaml.crt resources/certs/splunksaml.key >  resources/splunk/splunk-etc/auth/splunksaml.pem
cp resources/certs/keycloakapps.crt resources/splunk/splunk-etc/auth/idpCerts
